...
void Equipment::equipBodyArmor(BodyArmor& armor) {
    this->bodyArmor = &armor;
}

void Equipment::equipHelmet(Helmet& helmet) {
    this->helmet = &helmet;
}

void Equipment::equipShield(Shield& shield) {
    this->shield = &shield;
}
...
BodyArmor* Equipment::getBodyArmor() const {
    return this->bodyArmor;
}

Helmet* Equipment::getHelmet() const {
    return this->helmet;
}

Shield* Equipment::getShield() const {
    return this->shield;
}
