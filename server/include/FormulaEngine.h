...
public:
    ...
    uint16_t calculate_max_mana(uint16_t intelligence, float class_factor, float race_factor,
                                uint16_t level) const;
    ...
    uint16_t calculate_defense(uint16_t armor_min, uint16_t armor_max, uint16_t shield_min,
    ...
    uint32_t calculate_attack_xp_gain(uint16_t damage, uint16_t attacker_level,
