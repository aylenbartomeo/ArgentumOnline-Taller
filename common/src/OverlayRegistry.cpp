...
const std::vector<OverlayDef>& getOverlayRegistry() {
    static const std::vector<OverlayDef> registry = {
            ...
            {"armor/pechera-cuero.png", 0, 224, 32, 32, "Armadura de cuero", 1000, false},
            {"armor/pechera-hierro.png", 0, 224, 32, 32, "Armadura de placas", 1001, false},
            {"armor/tunica.png", 0, 224, 32, 32, "Tunica azul", 1002, false},
