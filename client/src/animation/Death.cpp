...
constexpr int GHOST_TILE = 32;
constexpr int GHOST_COL = 4;
constexpr int GHOST_ROW = 1;
...
FrameRect ghostFrameRect() {
    return FrameRect{(GHOST_COL - 1) * GHOST_TILE, (GHOST_ROW - 1) * GHOST_TILE, GHOST_TILE,
                     GHOST_TILE};
}
