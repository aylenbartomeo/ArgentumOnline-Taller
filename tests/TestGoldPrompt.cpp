...
TEST(GoldPromptTest, EmptyDefaultsToOne) {
    EXPECT_EQ(goldAmountFromText(""), 1);
}

TEST(GoldPromptTest, ParsesNumber) {
    EXPECT_EQ(goldAmountFromText("1000"), 1000);
}

TEST(GoldPromptTest, ZeroBecomesOne) {
    EXPECT_EQ(goldAmountFromText("0"), 1);
}
